...
class EigSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ----------------------------------------------------------------
        // Filiales (17 entités — Excelis avec un seul L)
        // ----------------------------------------------------------------
        $filiales = [
            ...
            ['id' => 'loans-recovery-company',      'sigle' => 'LRC', 'nom' => 'Loans Recovery Company',           'secteur' => 'Gestion de Créances',          'secteur_slug' => 'services-financiers',  'pays' => 'Burkina Faso',  'description' => "Société spécialisée dans la gestion des créances, à travers le recouvrement, le rachat et la restructuration de créances, avec pour mission d'accompagner les entreprises et institutions dans l'optimisation de leur trésorerie.", 'logo' => null, 'ordre' => 2, 'actif' => true],
            ['id' => 'barka-energies',              'sigle' => 'BE',  'nom' => 'Barka Energies',                   'secteur' => 'Énergie',                      'secteur_slug' => 'energie',              'pays' => 'Burkina Faso',  'description' => "Barka Energies intervient dans la distribution de produits pétroliers, principalement les carburants et lubrifiants, et dans la fourniture de solutions solaires adaptées aux besoins des particuliers, des entreprises et des institutions.", 'logo' => null, 'ordre' => 3, 'actif' => true],
            ['id' => 'sopatel-silmande',            'sigle' => 'SS',  'nom' => 'Sopatel Silmandé',                 'secteur' => 'Hôtellerie & Restauration',     'secteur_slug' => 'hotellerie',           'pays' => 'Burkina Faso',  'description' => "Établissement hôtelier de référence à Ouagadougou, offrant des services d'hébergement, de restauration et d'accueil haut de gamme au cœur de la capitale burkinabè.", 'logo' => null, 'ordre' => 4, 'actif' => true],
            ['id' => 'coris-assurance-iard-bf',    'sigle' => 'CA',  'nom' => 'Coris Assurance IARD BF',          'secteur' => 'Assurance Non-Vie',             'secteur_slug' => 'assurance',            'pays' => 'Burkina Faso',  'description' => "Conseil, conception et commercialisation de produits d'assurances non vie (Incendie, Accidents, Risques Divers) au Burkina Faso, sous régulation CIMA.", 'logo' => null, 'ordre' => 5, 'actif' => true],
            ...
            ['id' => 'coris-bourse',               'sigle' => 'CB',  'nom' => 'Coris Bourse',                     'secteur' => 'Marchés Financiers',            'secteur_slug' => 'marches-financiers',   'pays' => 'Burkina Faso',  'description' => "Société de Gestion et d'Intermédiation (SGI), Coris Bourse accompagne sa clientèle dans l'ouverture et la gestion de comptes-titres, ainsi que dans l'achat et la vente de valeurs mobilières cotées sur la BRVM.", 'logo' => null, 'ordre' => 9, 'actif' => true],
            ['id' => 'coris-asset-management',     'sigle' => 'CAM', 'nom' => 'Coris Asset Management',           'secteur' => "Gestion d'Actifs",              'secteur_slug' => 'marches-financiers',   'pays' => 'Burkina Faso',  'description' => "Société de Gestion d'OPCVM (SGO), spécialisée dans la gestion de fonds communs de placement et la gestion sous mandat d'investissements en valeurs mobilières sur la BRVM.", 'logo' => null, 'ordre' => 10, 'actif' => true],
            ['id' => 'expertis-bf',                'sigle' => 'EXB', 'nom' => 'Expertis BF',                      'secteur' => 'Immobilier & Capital-Risque',   'secteur_slug' => 'immobilier-capital',   'pays' => 'Burkina Faso',  'description' => "Spécialisée dans la tierce détention, le suivi d'exécution de projets, les investissements en capital-risque, la promotion immobilière et la maîtrise d'ouvrage déléguée.", 'logo' => null, 'ordre' => 11, 'actif' => true],
            ['id' => 'expertis-ci',                'sigle' => 'EXC', 'nom' => 'Expertis CI',                      'secteur' => 'Immobilier & Capital-Risque',   'secteur_slug' => 'immobilier-capital',   'pays' => "Côte d'Ivoire", 'description' => "Spécialisée dans la tierce détention, le suivi d'exécution de projets, les investissements en capital-risque, la promotion immobilière et la maîtrise d'ouvrage déléguée en Côte d'Ivoire.", 'logo' => null, 'ordre' => 12, 'actif' => true],
            ['id' => 'excelis',                    'sigle' => 'EX',  'nom' => 'Excelis',                          'secteur' => 'Technologies & Fintech',        'secteur_slug' => 'technologies-fintech', 'pays' => 'Burkina Faso',  'description' => "Fintech spécialisée dans la conception, le déploiement et la sécurisation de solutions numériques, au service de la digitalisation, du développement logiciel, de la monétique, du paiement digital et des services financiers digitaux.", 'logo' => null, 'ordre' => 13, 'actif' => true],
            ['id' => 'industries-arts-graphiques', 'sigle' => 'IAG', 'nom' => 'Industries des Arts Graphiques',   'secteur' => 'Industrie & Arts Graphiques',   'secteur_slug' => 'industrie',            'pays' => 'Burkina Faso',  'description' => "Spécialisée dans l'imprimerie, la conception graphique, la signalétique et la sécurisation de documents sensibles, tels que les timbres, diplômes et attestations automobiles.", 'logo' => null, 'ordre' => 14, 'actif' => true],
            ...
            ['id' => 'energytis',                  'sigle' => 'ET',  'nom' => 'Energytis',                        'secteur' => "Production d'Énergie",          'secteur_slug' => 'energie',              'pays' => 'Burkina Faso',  'description' => "Spécialisée dans l'étude, l'ingénierie, le développement, le financement, la construction et l'exploitation de sites de production d'énergie.", 'logo' => null, 'ordre' => 16, 'actif' => true],
            ['id' => 'general-mining-logistics',   'sigle' => 'GML', 'nom' => 'General Mining Logistics TS',      'secteur' => 'Transport & Logistique Minière','secteur_slug' => 'logistique-miniere',   'pays' => 'Burkina Faso',  'description' => "Intervient dans les services logistiques, techniques et opérationnels au profit des secteurs minier et industriel, notamment dans le transport d'agrégats miniers et l'appui aux opérations sur site.", 'logo' => null, 'ordre' => 17, 'actif' => true],
        ];
        ...
        $articles = [
            ...
            [
                ...
                'categorie'=> 'Corporate',
                'date'     => 'Janvier 2026',
                'extrait'  => "Avec +700 collaborateurs et 17 filiales actives, EIG consolide sa stratégie d'expansion multisectorielle en Afrique de l'Ouest.",
                'contenu'  => "Excellis Invest Group, holding multisectorielle fondée en 2019 et basée au Burkina Faso, consolide sa présence africaine avec un portefeuille de 17 filiales couvrant 9 secteurs stratégiques. Le Groupe compte désormais plus de 700 collaborateurs engagés dans la transformation économique de la sous-région.",
