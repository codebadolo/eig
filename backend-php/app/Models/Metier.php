...
class Metier extends Model {
    ...
    protected $fillable = ['id','slug','titre','titre_en','icone','couleur','description','description_en','enjeux','enjeux_en','contribution','contribution_en','filiales_ids','ordre','actif'];
