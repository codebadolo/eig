export const metiers = [
  {
    ...
    contribution: 'Excellis Invest Group positionne ses filiales financières comme des facilitateurs clés pour les entreprises et institutions locales, couvrant l\'intermédiation bancaire jusqu\'aux marchés financiers.',
    filiales: 4,
    filialesIds: ['intermediaire-des-services', 'loans-recovery-company', 'coris-bourse', 'coris-asset-management'],
  },
  {
    slug: 'assurance',
    titre: 'Assurance',
    ...
    contribution: 'Avec 4 entités d\'assurance vie et non-vie dans 2 pays, Excellis Invest Group couvre un spectre complet de la protection financière régionale.',
    filiales: 4,
  ...
  },
  {
    ...
    contribution: 'Excellis Invest Group accompagne les maîtres d\'ouvrage publics et privés tout en prenant des participations dans des projets à fort potentiel de création de valeur.',
    filiales: 2,
  ...
  },
  {
    ...
    contribution: 'Excellis Invest Group s\'engage dans toute la chaîne de valeur énergétique, de la distribution traditionnelle aux nouvelles énergies renouvelables.',
    filiales: 2,
  ...
  },
  {
    ...
    contribution: 'Excellis Invest Group contribue à la sécurisation documentaire de l\'État et des institutions à travers une filiale spécialisée et reconnue.',
    filiales: 1,
  ...
  },
  {
    ...
    contribution: 'Excellis Invest Group développe sa présence dans le secteur de l\'agribusiness pour accompagner la transformation des filières agricoles africaines.',
    filiales: 0,
    filialesIds: [],
  },
  {
  ...
  },
  {
    ...
    contribution: 'Sopatel Silmandé est une référence hôtelière, symbolisant l\'ancrage territorial et le rayonnement d\'Excellis Invest Group.',
    filiales: 1,
